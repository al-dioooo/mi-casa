...
export function ExperienceShell({ children, kind }: { children: ReactNode; kind: "greet" | "memories" | "playground" }) {
  return <div className="desktop-shell">
    <header className="site-header">
      ...
      <nav className="desktop-nav" aria-label="Main navigation"><Link href="/" aria-current={kind === "greet" ? "page" : undefined}><span>01</span> The birthday</Link><Link href="/memories" aria-current={kind === "memories" ? "page" : undefined}><span>02</span> Our memories</Link><Link href="/playground" aria-current={kind === "playground" ? "page" : undefined}><span>03</span> Playground</Link></nav>
